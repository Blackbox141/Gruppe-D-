...
class HotelManager:
    ...
    def add_hotel(self):
        hotel_name_input = str(input("Hotel Name: "))
        hotel_stars_input = int(input("Hotel Stars: "))
        street_input = str(input("Street: "))
        zip_input = int(input("Zip Code: "))
        city_input = str(input("City: "))
        room_number_input = int(input("Room number: "))
        ...
        room_price_input = float(input("Price per night: "))
